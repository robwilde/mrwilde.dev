...
|--------|-----------|---------------|-------|
| Avg Bedtime | 714.2 | 834.0 | -119.8 |
| Avg Wake Time | 459.2 | 453.0 | +6.2 |
| Avg Awakenings | 3.2 | 7.0 | -3.8 |
...
| Metric | This Week | Previous Week | Trend |
|--------|-----------|---------------|-------|
| Total Steps | 20,276.0 | 1,563.0 | +18,713.0 |
| Active Minutes | 783.0 min | 476.0 min | +307.0 min |
...
| Metric | This Week | Previous Week | Trend |
|--------|-----------|---------------|-------|
| Productive Time | 5,356.0 min | 6,036.0 min | -680.0 min |
| Neutral Time | 0.0 min | 11.0 min | -11.0 min |
...
- time_in_bed negatively correlates with sleep_end (5 stars)
