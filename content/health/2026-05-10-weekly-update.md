---
title: "Health Week: May 04 — May 10, 2026"
date: 2026-05-10
draft: false
layout: "post"
...
|--------|-----------|---------------|-------|
| Avg Bedtime | 1,019.0 | 765.0 | +254.0 |
| Avg Wake Time | 407.0 | 495.5 | -88.5 |
| Avg Awakenings | 4.0 | 2.0 | +2.0 |
...
| Metric | This Week | Previous Week | Trend |
|--------|-----------|---------------|-------|
| Total Steps | 1,715.0 | 7,442.0 | -5,727.0 |
...
| Metric | This Week | Previous Week | Trend |
|--------|-----------|---------------|-------|
| Productive Time | 4,826.0 min | 4,754.0 min | +72.0 min |
| Neutral Time | 3.0 min | 1.0 min | +2.0 min |
